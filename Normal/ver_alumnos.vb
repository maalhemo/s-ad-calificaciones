...
Imports System.Data
Public Class ver_alumnos

    Dim CONEXION As New MySqlConnection(" DataBase= normal; User Id=root; Password= mario; DataSource=localhost")
    Private Sub ver_alumnos_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            'Intentar conectar a la DB.
            CONEXION.Open()
            Dim cmd As New MySqlCommand("Select idalumno,nomalumno,apaternoalumno,amaternoalumno,idmateria from alumno", CONEXION)
    ...
    Public Sub ExportarDatosPDF(ByVal document As Document)
        ...
        Dim encabezado As New Paragraph("Reporte de Alumnos", New Font(Font.Name = "Tahoma", 20, Font.Bold))

        'Se crea el texto abajo del encabezado.
        Dim texto As New Phrase("Alumnos registrados a la fecha :" + Now.Date(), New Font(Font.Name = "Tahoma", 14, Font.Bold))
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim filename As String = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "\Reporte de alumnos.pdf"
