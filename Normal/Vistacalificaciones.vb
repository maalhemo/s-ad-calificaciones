...
Public Class Vistacalificaciones
    ...
    Private Sub Vistacalificaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            CONEXION.Open()
            Dim cmd As New MySqlCommand("Select alumno.idalumno,nomalumno,apaternoalumno,amaternoalumno,califinal from alumno inner join calificacion on alumno.idalumno=calificacion.idalumno", CONEXION)
    ...
    Public Sub ExportarDatosPDF(ByVal document As Document)
        ...
        Dim encabezado As New Paragraph("Reporte de calificaciones", New Font(Font.Name = "Tahoma", 20, Font.Bold))

        'Se crea el texto abajo del encabezado.
        Dim texto As New Phrase("Reporte de calificaciones finales a la fecha :" + Now.Date(), New Font(Font.Name = "Tahoma", 14, Font.Bold))
        Dim texto1 As New Phrase(" "" Profesor:  " & TextBox1.Text, New Font(Font.Name = "Tahoma", 14, Font.Bold))
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim filename As String = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "\Reporte de calificaciones.pdf"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show("Documento PDF generado revise su Escritorio.", "Creado", MessageBoxButtons.OK)
        End Try
    End Sub
